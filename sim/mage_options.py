...
class MageOptions:
    ...
    extend_ignite_with_scorch: bool = simoption("Extend ignite with Scorch instead of Fireball", default=False, spec="Fire")
    scorch_after_fire_blast: bool = simoption("Extend ignites with Scorch after Fire Blast", default=False, spec="Fire")
    ...
    interrupt_arcane_missiles_for_sulfuras_proc: bool = simoption("Interrupt Arcane Missiles early for Sulfuras haste proc", default=False, spec="Arcane")
